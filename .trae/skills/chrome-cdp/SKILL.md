---
name: "chrome-cdp"
description: "Lightweight Chrome DevTools Protocol CLI for browser automation. Invoke when user needs to take screenshots, evaluate JavaScript, click elements, type text, navigate pages, or automate Chrome browser tasks."
---
...
**Warning:** Avoid index-based selection (`querySelectorAll(...)[i]`) across multiple eval calls when the DOM can change between them (e.g. after clicking Ignore, card indices shift). Collect all data in one eval or use stable selectors.
